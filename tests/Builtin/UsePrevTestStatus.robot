...
Test different ways to create RFW dictionaries
    [Tags]    setup
    Fail    for testing purpose
    # Create dict objects
    
Test different ways to create RFW dictionaries2
    [Documentation]    ${PREV TEST STATUS} is robot fw variable returns the previous test status.
    Log    ${PREV TEST STATUS}
    Run Keyword If    '${PREV TEST STATUS}' == 'PASS'    Create dict objects
